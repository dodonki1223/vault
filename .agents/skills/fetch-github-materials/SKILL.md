...
4. PR ごとに、状態、review 状況、未解決コメント、CI、mergeability、関連 issue / Linear / Slack / Docs を確認する。
5. CI 失敗は、失敗 job 名、失敗時刻、ログへのリンク、Project 影響が分かる範囲だけ残す。
6. closed / merged PR は、現在判断に必要なものだけ残す。不要な履歴は落とす。
7. 追加取得しても bot 更新や重複しか出なくなったら止める。
